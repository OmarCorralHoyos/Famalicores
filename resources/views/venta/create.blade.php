...
<form action="/ventas" method="POST">
    @csrf
  <div class="mb-3">
    <label for="" class="form-label">Fecha_de_venta</label>
    <input id="Fecha_de_venta" name="Fecha_de_venta" type="date" class="form-control" tabindex="1">    
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input id="Cantidad" name="Cantidad" type="number" value="0" onchange="multiplicar();" class="form-control" tabindex="3">
  </div>
  <div class="mb-3">
    <label for="" class="form-label">Precio</label>
    <input id="Precio" name="Precio" type="number" step="any" value="0.00" onchange="multiplicar();" class="form-control" tabindex="3">
  </div>
  <div class="mb-3">
